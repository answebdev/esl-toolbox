...
This responsive front-end website was created using Bootstrap, CSS, and HTML. The font used ('Quicksand') comes from Google Fonts. The landing page image comes from Pexels. The icons used on the Search and Back buttons come from Font Awesome. The Share buttons on the landing page come from ShareThis. The Comments section is processed by GraphComment. The ESL Toolbox logo, the images used on the cards, and the preview image (see screenshot #4 below) was created using Canva.
